<div class="row">
    <div class="col-md-12">
        ...
        <p class="lead">Halaman ini adalah halaman indeks pemilu. Untuk membuat pemilu baru: <a href="<?php echo Router::url(array('controller' => 'elections', 'action' => 'add')) ?>" class="btn btn-default"><span class="glyphicon glyphicon-check"></span> Buat Pemilu</a></p>
